<x-layouts.app title="Edit Idea">
    <div class="flex flex-col gap-4 max-w-3xl mx-auto w-full">
        <div class="flex items-center gap-3 bg-white dark:bg-gray-950 p-4 border border-gray-200 dark:border-gray-800 rounded-lg shadow-sm">
            ...
            <div>
                <h1 class="font-bold text-gray-800 dark:text-white text-lg">Edit Idea</h1>
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Refine your brainstorm.</p>
            </div>
        </div>
            ...
            <form action="{{ route('ideas.update', $idea) }}" method="POST" class="space-y-4 text-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="space-y-1.5 md:col-span-2">
                        ...
                        <input type="text" id="title" name="title" value="{{ old('title', $idea->title) }}" required class="w-full bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-md px-3 py-2 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-400 dark:focus:ring-gray-600 transition-shadow">
