<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-lg shadow-sm p-4">
        ...
        <div class="flex gap-4">
            <div class="w-64">
                ...
                <select wire:model.live="userId" class="w-full bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 text-gray-800 dark:text-gray-200 text-sm rounded px-2 py-1.5 focus:outline-none focus:border-indigo-500 transition-colors">
    ...
    <div class="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-lg shadow-sm p-4">
        ...
        <div class="flex flex-col md:flex-row items-end gap-4">
            <div class="w-full md:w-64">
                <label class="block text-xs text-gray-500 mb-1">Base Period</label>
                <select wire:model.live="basePeriod" class="w-full bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 text-gray-800 dark:text-gray-200 text-sm rounded px-2 py-1.5 focus:outline-none focus:border-indigo-500 transition-colors">
            ...
            <div class="w-full md:w-64">
                <label class="block text-xs text-gray-500 mb-1">Comparison Period</label>
                <select wire:model.live="comparePeriod" class="w-full bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 text-gray-800 dark:text-gray-200 text-sm rounded px-2 py-1.5 focus:outline-none focus:border-indigo-500 transition-colors">
                    <option value="today">Today</option>
                    <option value="yesterday">Yesterday</option>
                    <option value="this_week">This Week</option>
                    <option value="last_week">Last Week</option>
        ...
        <div class="mt-6 p-4 rounded bg-gray-50/50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 flex items-center justify-between">
            <div>
                <p class="text-xs text-gray-500 uppercase tracking-wider font-semibold mb-1">Delta Analysis</p>
                <div class="flex items-baseline gap-2">
                    <span class="text-2xl font-bold text-gray-800 dark:text-gray-200">{{ number_format($customBaseSeconds / 3600, 1) }}h</span>
            ...
            <div class="text-right">
                ...
                <p class="text-xs text-gray-500 mt-0.5">{{ $isPositive ? '+' : '' }}{{ number_format($delta / 3600, 1) }} hours difference</p>
            </div>
        </div>
        ...
        <div class="mt-4">
            <div class="w-full bg-gray-200 dark:bg-gray-800 rounded-full h-2 overflow-hidden flex">
                ...
                @endphp
                <div class="bg-indigo-500 h-full transition-all duration-1000" style="width: {{ $baseW }}%"></div>
            </div>
    ...
    <div class="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-lg shadow-sm p-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <!-- Daily -->
            <div class="p-4 rounded border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900">
                <div class="text-xs text-gray-500 uppercase tracking-wider font-semibold mb-2">Today vs Yesterday</div>
                <div class="flex items-end justify-between mb-2">
                    <span class="text-xl font-bold text-gray-800 dark:text-gray-200">{{ number_format($todaySeconds / 3600, 1) }}h</span>
            ...
            <!-- Weekly -->
            <div class="p-4 rounded border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900">
                <div class="text-xs text-gray-500 uppercase tracking-wider font-semibold mb-2">This Week vs Last</div>
                <div class="flex items-end justify-between mb-2">
                    <span class="text-xl font-bold text-gray-800 dark:text-gray-200">{{ number_format($thisWeekSeconds / 3600, 1) }}h</span>
            ...
            <!-- Monthly -->
            <div class="p-4 rounded border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900">
                <div class="text-xs text-gray-500 uppercase tracking-wider font-semibold mb-2">This Month vs Last</div>
                <div class="flex items-end justify-between mb-2">
                    <span class="text-xl font-bold text-gray-800 dark:text-gray-200">{{ number_format($thisMonthSeconds / 3600, 1) }}h</span>
