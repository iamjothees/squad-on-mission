<x-layouts.app title="New Task">
    <div class="flex flex-col gap-4 max-w-3xl mx-auto w-full">
        <div class="flex items-center gap-3 bg-white dark:bg-gray-950 p-4 border border-gray-200 dark:border-gray-800 rounded-lg shadow-sm">
            ...
            <div>
                <h1 class="font-bold text-gray-800 dark:text-white text-lg">New Task</h1>
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Add a new item to your productivity tracker.</p>
            </div>
        </div>
            ...
            <form action="{{ route('tasks.store') }}" method="POST" class="space-y-4 text-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="space-y-1.5 md:col-span-2">
                        ...
                        <input type="date" id="due_date" name="due_date" value="{{ old('due_date') }}" class="w-full md:w-1/2 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-md px-3 py-2 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-400 dark:focus:ring-gray-600 transition-shadow">
