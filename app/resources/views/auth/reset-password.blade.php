...
<body class="h-full flex items-center justify-center bg-bg px-4 sm:px-6 lg:px-8">
 ...
 <div>
 <h2 class="mt-2 text-center text-3xl font-bold tracking-tight text-fg">Reset Password</h2>
 </div>
 ...
 <input id="password" name="password" type="password" required class="relative block w-full appearance-none border border-border bg-surface px-3 py-2 text-fg placeholder-gray-500 focus:z-10 focus:border-accent focus:outline-none focus:ring-accent sm:text-sm" placeholder="New Password">
 </div>
 <div>
